...
// NewSegmenter tokenizes a reader into a stream of tokens according to Unicode Text Segmentation word boundaries https://unicode.org/reports/tr29/#Word_Boundaries.
// Iterate through the stream by calling Next() until false.
//	text := []byte("This is an example.")
//
//	segment := words.NewSegmenter(text)
//	for segment.Next() {
//		fmt.Printf("%q\n", segment.Text())
//	}
